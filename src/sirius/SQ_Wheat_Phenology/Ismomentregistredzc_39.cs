...
{
    public class IsMomentRegistredZC_39 : IStrategySiriusQualityPhenology
    {
        public IsMomentRegistredZC_39()
        {
            ...
            pd2.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39);
            _outputs0_0.Add(pd2);
        ...
        public string TestPostConditions(SiriusQualityPhenology.DomainClass.PhenologyState s,SiriusQualityPhenology.DomainClass.PhenologyState s1,SiriusQualityPhenology.DomainClass.PhenologyRate r,SiriusQualityPhenology.DomainClass.PhenologyAuxiliary a,SiriusQualityPhenology.DomainClass.PhenologyExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r2 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39);
                if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39.ValueType)){prc.AddCondition(r2);}
